...
{
  /*TD跟踪微分器   最速TD,h0=N*h      扩张状态观测器ESO           扰动补偿     非线性组合*/
  /*  r     h      N                  beta_01   beta_02    beta_03     b0     beta_0  beta_1     beta_2     N1     C    alpha1  alpha2  zeta       b*/
  {1000000 ,0.0009 , 5,               300,      10000,      1000,      35,    0.85,   0.09,      0.001,       2,    5,    0.9,   1.2,    0.03,    0.1},
  {1000000 ,0.0009 , 5,               300,      10000,      1000,      35,    0.85,   0.09,      0.001,       2,    5,    0.9,   1.2,    0.03,    0.1},
  {300000  ,0.0009 , 3,               300,      10000,      1000,     35,   0.2,    0.5,      0.0010,       5,      5,    0.8,   1.5,    0.03,    0.05},
};
